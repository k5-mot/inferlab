...
PNG の多くは [Homarr Labs Dashboard Icons](https://github.com/homarr-labs/dashboard-icons/tree/main/png) から取得した製品アイコンです。ライセンスは `LICENSE.dashboard-icons` を参照してください。
