...
HARBOR_INSTALLER_DIR="${HARBOR_INSTALLER_DIR:-30-developer/harbor/installer}"

# Harborが生成したdocker-compose.ymlのcopy先を指定する。
HARBOR_COMPOSE_OUTPUT_DIR="${HARBOR_COMPOSE_OUTPUT_DIR:-30-developer/harbor/generated}"
